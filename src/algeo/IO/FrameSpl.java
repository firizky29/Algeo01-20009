...
public class FrameSpl extends JFrame {
    ...
    public FrameSpl() {
        ...
        JLabel var = new JLabel("#Variabel =");
        ...
        cIn.gridx = 1;
        panelIn.add(col,cIn);
        JLabel pers = new JLabel("#persamaan =");
...
/*
        ...
        JLabel output = new JLabel("Output:");
        output.setBounds(0,0,100,50);
        panelOut.add(output);
        res = new JTextField();
        res.setEditable(false);
        res.setBounds(0,50,100,100);
        panelOut.add(res);
        save = new JButton("Save");
        save.setBounds(100,75,100,50);
        panelOut.add(save);
        pathOut = new JTextField();
        pathOut.setEditable(false);
        pathOut.setBounds(save.getX(),save.getY()+50,100,50);
        panelOut.add(pathOut);
*/
